...
abbrev A1 := LLTL[(((← params__weather__) = (0)) ∨ ((← params__weather__) = (1))) ∧ ((← params__lead_car_width__) ≥ (1.8))]

abbrev assumptions : TraceSet TraceState := LLTL[A0 ∧ A1]

-- Internal Assumptions
abbrev IA0 := LLTL[𝐆 (self._lane_is_not_None)]
abbrev IA1 := LLTL[(← params__lead_car_width__) ≥ (1.8)]
abbrev IA2 := LLTL[((← params__weather__) = (0)) ∨ ((← params__weather__) = (1))]
